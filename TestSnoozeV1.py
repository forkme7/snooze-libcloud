...
class TestSnooze(unittest.TestCase):
    ...
    def test_create_node(self):
        ...
        self.assertEqual(self.n1.state,"LAUNCHING", msg="the state is not set correctly" )
    ...
    def test_created_node(self):
        ...
        self.assertEqual(info.get("monitoringStatus"),"ACTIVE")
    ...
    def test_suspend_node(self):
        ...
        #monitoring check status
        self.assertEqual(info.get("monitoringStatus"),"PAUSED")
    ...
    def test_shutdown_node(self):
        ...
        #monitoring check status
        self.assertEqual(info.get("monitoringStatus"),"STOPPED")
        time.sleep(5)
